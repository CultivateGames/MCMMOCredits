    ...
    public static class Builder {
        ...
        public TagResolver build() {
            if (this.tags.containsKey("player")) {
                this.tags.put("sender_credits", Database.getDatabase().getCredits(player.getUniqueId()) + "");
            }
        ...
        public Builder player(@Nullable Player player) {
            if (player != null) {
                ...
                this.tags.put("credits", Database.getDatabase().getCredits(player.getUniqueId()) + "");
            }
        ...
        public Builder player(String username, UUID uuid) {
            ...
            this.tags.put("credits", Database.getDatabase().getCredits(uuid) + "");
