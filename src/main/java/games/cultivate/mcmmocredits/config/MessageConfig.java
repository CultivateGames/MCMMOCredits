...
public class MessageConfig {
    ...
    private String credits_check_self = "<green>You have %credits% MCMMO Credits!";

    @Comment("Shown to user when they check the MCMMO Credit balance of another user with /credits.")
    private String credits_check_other = "<green>%player% has %credits% MCMMO Credits!";
    ...
    private String redeem_skill_cap = "<red>You cannot redeem this many MCMMO Credits into %skill%, due to the Level Cap (%cap%).";

    @Comment("Shown to user when they try to redeem more MCMMO Credits than they have available.")
    private String redeem_not_enough_credits = "<red>You do not have enough MCMMO Credits to do this!";

    @Comment("Shown to user when they successfully redeem MCMMO Credits into a skill.")
    private String redeem_successful = "<green>Redemption Successful! You have redeemed %amount% Credits into %skill%. You have %credits% Credits remaining.";

    @Comment("Shown to user when they successfully redeem MCMMO Credits into a skill.")
    private String redeem_successful_other = "<green>Redemption Successful! You have redeemed %amount% Credits into %skill% for %player%. They have %credits% Credits remaining.";
    ...
    private String modify_credits_add = "<green>You have given %amount% Credits to %player%";
    ...
    private String modify_credits_set = "<yellow>You have set %player%'s Credits to %amount%!";
    ...
    private String modify_credits_take = "<red>You have taken %amount% Credits from %player%";
